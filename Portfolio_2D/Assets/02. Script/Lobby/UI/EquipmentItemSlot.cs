...
namespace Portfolio.UI
{
    public class EquipmentItemSlot : MonoBehaviour
    {
        ...
        [SerializeField] eEquipmentItemType equipmentItemType;   // 장비 슬롯의 기본 장비 타입
        ...
        // GradeColor
        Color normalColor = Constant.NormalItemGradeColor;               // 평범 등급 색
        Color rareColor = Constant.RareItemGradeColor;                   // 희귀 등급 색
        Color uniqueColor = Constant.UniqueItemGradeColor;               // 고유 등급 색
        Color legendaryColor = Constant.LegendaryItemGradeColor;         // 전설 등급 색
