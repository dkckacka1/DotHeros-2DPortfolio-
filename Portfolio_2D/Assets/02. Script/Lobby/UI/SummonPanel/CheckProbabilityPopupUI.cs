...
namespace Portfolio.Lobby.Summon
{
    public class CheckProbabilityPopupUI : MonoBehaviour
    {
        ...
        {
            probablilityText.text = $"1성 유닛 획득 확률 : {Constant.NormalUnitSummonPercent * 100}%";
        ...
        {
            probablilityText.text = $"1성 유닛 획득 확률 : {Constant.RareUnitSummonPercent * 100}%";
        ...
        {
            probablilityText.text = $"1성 유닛 획득 확률 : {Constant.UniqueUnitSummonPercent * 100}%";
